  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
      ...
      <div class="flex flex-col">
        <div class="mb-6">
          <div
            class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest bg-green-100 text-green-700 shadow-sm border border-green-200 mb-4"
          >
          ...
          <div class="mb-8">
            <template v-if="product?.dealerPrice">
              <div class="flex items-center gap-3">
                <span class="text-4xl font-extrabold text-green-600">{{
                  new Intl.NumberFormat('en-NG', { style: 'currency', currency: product?.CURRENCY_ID || 'NGN' }).format(
                ...
                <span
                  class="inline-flex items-center px-2 py-1 rounded text-xs font-bold uppercase tracking-widest bg-green-100 text-green-700"
                  >Dealer Price</span
                >
              </div>
            </template>
          ...
          <p class="text-gray-600 text-lg leading-relaxed mb-8">
            {{
              product?.DESCRIPTION ||
              'Engineered for maximum power harvesting even in low-light environments. Guaranteed quality and performance for your energy needs.'
            }}
          </p>
        </div>
    ...
    <div class="mb-20">
      <div class="flex border-b border-gray-200 mb-8 overflow-x-auto no-scrollbar">
        <button
          ...
          :key="tab"
          :class="[
            'px-8 py-4 font-bold text-sm uppercase tracking-widest transition-all border-b-2 whitespace-nowrap',
      ...
      <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm animate-in fade-in slide-in-from-bottom-2">
        ...
        <div v-if="activeTab === 'Technical Specifications'">
          <table class="w-full border-collapse">
            <thead>
              <tr class="bg-gray-50">
                <th class="text-left py-4 px-6 text-xs font-bold text-gray-500 uppercase tracking-wider border-b">
                  Parameter
                </th>
                <th class="text-left py-4 px-6 text-xs font-bold text-gray-500 uppercase tracking-wider border-b">
                  Value
            ...
            <tbody class="divide-y divide-gray-100">
              <tr>
                <td class="py-4 px-6 font-semibold text-gray-700">Peak Power (Pmax)</td>
                <td class="py-4 px-6 text-gray-600">450W</td>
              </tr>
              <tr>
                <td class="py-4 px-6 font-semibold text-gray-700">Cell Type</td>
                <td class="py-4 px-6 text-gray-600">Monocrystalline silicon</td>
              </tr>
              <tr>
                <td class="py-4 px-6 font-semibold text-gray-700">Module Efficiency</td>
                <td class="py-4 px-6 text-gray-600">22.8%</td>
              </tr>
              <tr>
                <td class="py-4 px-6 font-semibold text-gray-700">Operating Temperature</td>
                <td class="py-4 px-6 text-gray-600">-40°C to +85°C</td>
              </tr>
              <tr>
                <td class="py-4 px-6 font-semibold text-gray-700">Dimensions</td>
                <td class="py-4 px-6 text-gray-600">1903 x 1134 x 30 mm</td>
              </tr>
              <tr>
                <td class="py-4 px-6 font-semibold text-gray-700">Weight</td>
                <td class="py-4 px-6 text-gray-600">24.2 kg</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div v-if="activeTab === 'Product Description'" class="max-w-3xl prose prose-blue">
          <p class="text-gray-600 text-lg leading-relaxed">
            The Ultra-Efficiency 450W series panels represent the pinnacle of modern solar engineering. Developed for
            regions with variable irradiance, these panels utilize PERC technology combined with half-cut cell
            architecture to minimize internal resistive losses.
          </p>
          <h4 class="font-bold text-gray-900 mt-8 mb-4">Key Benefits:</h4>
          <ul class="space-y-3 text-gray-600">
            <li class="flex items-start gap-2">
              <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
        ...
        <div v-if="activeTab === 'Downloads'" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <a
            ...
            :key="file"
            href="#"
            class="flex items-center justify-between p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:bg-blue-50 hover:border-blue-200 transition-all group"
          >
    ...
    <section class="bg-primary rounded-[2.5rem] p-12 overflow-hidden relative group">
      <div class="absolute inset-0 bg-blue-900/50 opacity-0 group-hover:opacity-20 transition-opacity" />
      <div class="max-w-2xl relative z-10 text-center mx-auto">
        ...
        <p class="text-blue-100 text-lg mb-8">
          Planning a large-scale project? Get a personalized quote for bulk orders, custom logistics, and technical
          consulting.
        </p>
        <NuxtLink
          to="/contact"
          class="bg-white text-primary px-10 py-4 font-bold rounded-2xl shadow-xl hover:scale-105 transition-transform active:scale-95 inline-flex items-center justify-center"
        >
          Contact Sales Team
        </NuxtLink>
      </div>
      <!-- Decorative circles -->
      <div
        class="absolute -right-20 -top-20 w-80 h-80 bg-blue-500 rounded-full blur-3xl opacity-20 transition-transform duration-700 group-hover:scale-110"
      />
      <div
        class="absolute -left-20 -bottom-20 w-80 h-80 bg-blue-600 rounded-full blur-3xl opacity-20 transition-transform duration-700 group-hover:scale-110"
      />
    </section>
  </div>
</template>
