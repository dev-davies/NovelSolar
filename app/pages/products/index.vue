    ...
    <div class="flex flex-col lg:flex-row gap-8">
      ...
      <aside class="lg:w-1/4 space-y-8">
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
          ...
          <div class="mb-8">
            ...
            <div class="space-y-3">
              <label class="flex items-center gap-3 cursor-pointer group">
                <input v-model="filters.inStock" type="checkbox" class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary">
                <span class="text-sm text-gray-600 group-hover:text-primary transition-colors">In Stock</span>
              </label>
              <label class="flex items-center gap-3 cursor-pointer group">
                <input v-model="filters.onBackorder" type="checkbox" class="w-5 h-5 rounded border-gray-300 text-primary focus:ring-primary">
          ...
          <div class="mb-8">
            ...
            <div class="px-2">
              <input v-model="filters.priceRange" type="range" :min="0" :max="5000" :step="100" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary">
          ...
          <div class="mb-8">
            <h3 class="text-sm font-semibold text-gray-800 uppercase tracking-wider mb-4">Wattage (W)</h3>
             <div class="px-2">
              <input v-model="filters.wattage" type="range" :min="100" :max="700" :step="10" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary">
              <div class="flex justify-between mt-3 text-xs text-gray-500 font-medium">
                <span>100W</span>
          ...
          <div class="mb-4">
            ...
            <div class="px-2">
              <input v-model="filters.efficiency" type="range" :min="15" :max="25" :step="0.5" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-primary">
              <div class="flex justify-between mt-3 text-xs text-gray-500 font-medium">
                <span>15%</span>
      ...
      <main class="lg:w-3/4">
        ...
        <div v-else class="text-center py-20 bg-white rounded-2xl shadow-sm border border-gray-100">
          ...
          <div class="mt-6">
            <button class="bg-[#002888] text-white px-6 py-2.5 rounded-lg text-sm font-bold hover:bg-blue-900 transition-colors shadow-sm" @click="resetFilters">
              Reset all filters
            </button>
          </div>
        </div>
