  ...
  <div class="min-h-screen bg-white font-sans selection:bg-blue-500/30">
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center text-left">
          <div v-reveal>
            ...
            <p class="text-xl text-slate-400 max-w-xl mb-12 leading-relaxed font-medium">
              Novel Solar is proud to partner with Haisic to bring you enterprise-grade LiFePO4 energy storage and smart hybrid inverters.
            </p>
            <NuxtLink 
    ...
    <section class="py-24 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-20">
        <h2 v-reveal class="text-4xl font-black text-slate-900 tracking-tight uppercase italic mb-4">Why Choose Haisic?</h2>
        <div v-reveal class="w-20 h-1.5 bg-blue-600 mx-auto rounded-full"></div>
      </div>
      
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-3 gap-12">
          <!-- Spec 1 -->
          <div v-reveal class="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:border-blue-200 transition-colors group">
    ...
    <section class="py-24 bg-slate-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        ...
        <p v-reveal class="text-slate-500 font-medium italic">Inside the Haisic ecosystem: Engineered for performance and longevity.</p>
      </div>
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <section class="py-24 bg-blue-600 relative overflow-hidden">
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <p v-reveal class="text-xl text-blue-100 mb-12 font-medium opacity-80">
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Explore Haisic industrial and residential solar solutions. Built for power, designed for durability.' }
  ]
})
</script>
