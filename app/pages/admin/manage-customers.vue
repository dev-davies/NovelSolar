...
const handleTrashCustomer = async (id: string) => {
  if (!confirm('Are you sure you want to remove this customer? They will be moved to the trash.')) return
  ...
  try {
    ...
    alert(error.statusMessage || 'Failed to trash customer')
  } finally {
