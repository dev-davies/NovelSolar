  ...
  <div class="min-h-screen bg-white font-sans selection:bg-blue-500/30">
    ...
    <section class="py-24 bg-white">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-3 gap-12">
          <!-- Spec 1 -->
          <div class="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:border-blue-200 transition-colors group">
    ...
    <section class="py-24 bg-slate-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
        ...
        <p class="text-slate-500 font-medium italic">Inside the Haisic ecosystem: Engineered for performance and longevity.</p>
      </div>
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
