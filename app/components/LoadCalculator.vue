  ...
  <div class="max-w-6xl mx-auto px-4 py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
      ...
      <div class="lg:col-span-2 space-y-6">
                  ...
                  >
                    <td class="px-6 py-4">
                      <div class="flex items-center gap-3">
                        <div
                          class="w-8 h-8 rounded-lg flex items-center justify-center transition-colors px-1"
                        ...
                        <span
                          ...
                          :class="item.quantity > 0 ? 'text-[#002888]' : 'text-gray-700'"
                        >
                          {{ item.name }}
                        </span>
                      </div>
        ...
        <div
          class="p-4 bg-blue-50/50 rounded-xl border border-blue-100 border-dashed flex items-center justify-between"
        >
          <p class="text-xs text-blue-600 font-medium italic">
            Tip: You can manually adjust the "Unit Load" for any appliance to match your specific hardware.
          </p>
        </div>
      </div>
      ...
      <div class="space-y-6 lg:sticky lg:top-24">
        <div class="bg-[#002888] rounded-2xl shadow-xl shadow-blue-900/20 text-white overflow-hidden">
          <div class="p-6 border-b border-white/10 flex items-center justify-between">
            ...
            <span
              class="bg-blue-400/20 text-blue-100 text-[10px] uppercase tracking-widest font-black px-2 py-1 rounded"
              >Live</span
            >
          </div>
          ...
          <div class="p-6 space-y-5">
            <div class="bg-white/10 rounded-xl p-4 flex items-center justify-between">
              <div>
                ...
                <h3 class="text-3xl font-black">
                  {{ totalLoad.toFixed(0) }}<span class="text-lg font-normal ml-1">Watts</span>
                </h3>
              </div>
            ...
            <div class="grid grid-cols-1 gap-4">
              <div
                ...
                :key="stat.label"
                class="flex justify-between items-center text-sm py-2 border-b border-white/5 last:border-0"
              >
        ...
        <div class="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
          ...
          <a
            :href="whatsappUrl"
            target="_blank"
            class="text-sm font-bold text-[#002888] hover:underline flex items-center gap-1"
          >
            Chat on WhatsApp
...
const {
  public: { whatsappNumber, whatsappNumberFormatted },
} = useRuntimeConfig()
...
const costRange = computed(() => {
  ...
  const priceTiers = calculator?.priceTiers || [
...
const handlePdfDownload = () => {
  ...
  const tableBody = appliances.value
    ...
    .map((item) => [item.name, item.quantity, `${item.load}W`, `${item.quantity * item.load}W`])
  ...
  doc.text(
    `Visit www.novelsolar.com or call ${whatsappNumberFormatted} for a formal site audit.`,
    20,
