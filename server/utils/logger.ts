...
export class Logger {
  ...
  private constructor() {
    ...
    this.isDev = this.isServer ? process.env.NODE_ENV === 'development' : import.meta.env?.DEV || false
  }
  ...
  private formatMessage(context: string, message: string, meta?: Record<string, unknown>): string {
